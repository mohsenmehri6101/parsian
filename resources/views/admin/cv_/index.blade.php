                ...
                <table class="table table-condensed table-hover">
                    ...
                    @foreach($fani_db as $fani_db2)
                        <tr>
                            ...
                            <td>
                                <a href="<?= Url('admin/cv_/'.$fani_db2->id.'/edit') ?>">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2">
                                        <form action="<?= Url('admin/cv_/'.$fani_db->id); ?>" method="POST">
                ...
                <div id="{{$fani_db->id }}" class="modal fade" role="dialog">
                    <div class="modal-dialog" >
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <a href="<?= Url('admin/cv_/'.$fani_db->id.'/edit') ?>" title="  ویرایش {{ $fani_db->title }}" class="close" data-target="#{{$fani_db->id }}_edit">
